/**
 * Supabase Data Uploader for Spikeball NATS Tournaments
 */
...
function getTournamentCircuit(slug, name) {
  ...
  return 'NATS'; // Default fallback for this specific script which handles NATS data
}

async function uploadAll() {
  console.log('🚀 Starting import to Supabase...');

  const dataPath = path.join(__dirname, '../data/nats-tournaments-2026.json');
  ...
  console.log('\n🎉 ALL 10 NATS TOURNAMENTS SUCCESSFULLY IMPORTED INTO SUPABASE!');
}
